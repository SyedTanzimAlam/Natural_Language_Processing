...
class Snipper(QtWidgets.QWidget):
    def __init__(self, parent=None, flags=Qt.WindowFlags()):
        ...
        self.setWindowTitle("Syed Tehzeeb")
        self.setWindowFlags(
...
def notify(msg):
    try:
        Notification(title="Syed Tehzeeb", description=msg).send()
        ...
        trayicon.show()
        trayicon.showMessage("Syed Tehzeeb", msg, QtWidgets.QSystemTrayIcon.NoIcon)
        trayicon.hide()
